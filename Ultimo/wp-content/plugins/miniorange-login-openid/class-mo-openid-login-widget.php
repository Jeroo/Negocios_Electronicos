	...
	public function openidloginFormShortCode( $atts ){
		global $post;
				...
				if( ! is_user_logged_in() ) {
					...
					if( $appsConfigured ) {
						$this->mo_openid_load_login_script();
					$html .= "<a href='http://miniorange.com/cloud-identity-broker-service' style='display:none;'></a><a href='http://miniorange.com/strong_auth' style='display:none;'></a><a href='http://miniorange.com/single-sign-on-sso' style='display:none;'></a>
<a href='http://miniorange.com/fraud' style='display:none;'></a>
