...
function mo_openid_pricing_info(){ ?>
	<td style="vertical-align:top;width:100%;">
		...
		<span style="float:right">
			<input type="button" name="check_plan" id="check_plan" <?php if(!mo_openid_is_customer_registered()) echo 'disabled'?> class="button button-primary button-large" value="Check Plan" onclick="checkLicense();"/>
